...
- В свое время (семидесятые годы XX века), в составе периферийной части комплекта микросхем поддержки икропроцессора 8080, компания Intel разработала два контроллера последовательного порта. Один из них, `8250`, получил название `UART (Universal Asynchronous Receiver/Transmitter)` - универсальный асинхронный приемник-передатчик. Второй, `8251`, получил название `USART (Universal Synchronous/Asynchronous Receiver/Transmitter)` - универсальный синхронно-асинхронный приемник-передатчик.
